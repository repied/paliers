...
[bottomTimeInput, maxDepthInput].forEach(input => {
    ...
    input.addEventListener('input', () => {
        if (input.id === 'bottomTime') {
            bottomTimeSlider.value = input.value;
        }
        if (input.id === 'maxDepth') {
            maxDepthSlider.value = input.value;
        }
    });
});
// Sliders
[bottomTimeSlider, maxDepthSlider].forEach(slider => {
    slider.addEventListener('input', () => {
        ...
        if (slider.id === 'bottomTimeSlider')
            bottomTimeInput.value = slider.value;
        if (slider.id === 'maxDepthSlider')
            maxDepthInput.value = slider.value;
