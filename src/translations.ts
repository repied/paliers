...
export const TRANSLATIONS: Translations = {
  "en": {
    "warning-banner": "Calculations may not be 100% correct.",
    ...
    "ambiantPressureLabel": "Ambiant pressure",
    "pn2ambiantLabel": "P_N2",
    "compartmentTensionLabel": "Tensions",
    ...
    "relativeTensionLabel": "Relative Tension to M-Value (GF99)",
  ...
  "fr": {
    "warning-banner": "Les calculs ne sont peut être pas 100% corrects.",
    ...
    "ambiantPressureLabel": "Pression ambiante",
    ...
    "tensionLabel": "Tension",
    "relativeTensionLabel": "Tension relative a la M-Value (GF99)",
