...
export const TRANSLATIONS: Translations = {
  "en": {
    ...
    "intro1_mobile": "ZHL-16C on air. Click or arrow keys to change GFs. Topright icon to show saturated compartments.",
  ...
  "fr": {
    ...
    "intro1_mobile": "ZHL-16C a l'air. Cliquez ou utilisez les flèches pour changer les FGs. Icône en haut à droite pour afficher les compartiments saturés.",
